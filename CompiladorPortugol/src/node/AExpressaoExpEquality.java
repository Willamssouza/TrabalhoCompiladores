...
public final class AExpressaoExpEquality extends PExpEquality
{
    private PExpRelational _expRelational_;

    public AExpressaoExpEquality()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpressaoExpEquality(
    ...
    {
        ((Analysis) sw).caseAExpressaoExpEquality(this);
    }
