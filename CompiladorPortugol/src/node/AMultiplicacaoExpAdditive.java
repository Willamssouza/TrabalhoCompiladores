...
public final class AMultiplicacaoExpAdditive extends PExpAdditive
{
    private PExpMultiplicative _expMultiplicative_;

    public AMultiplicacaoExpAdditive()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMultiplicacaoExpAdditive(
    ...
    {
        ((Analysis) sw).caseAMultiplicacaoExpAdditive(this);
    }
